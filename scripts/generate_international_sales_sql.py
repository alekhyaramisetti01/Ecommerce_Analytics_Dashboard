...
df = pd.read_csv("../data/processed/international_sales_cleaned.csv")
...
print(create_sql)
with open("../sql/create_tables/create_table_international_sales.sql", "w") as f:
    f.write(create_sql)

print("✅ SQL script saved to sql/create_tables_create_table_international_sales.sql")
